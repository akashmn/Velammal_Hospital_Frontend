...
const HeroSection: React.FC = () => {
  return (
    ...
    <div className="z-0 flex flex-col ml-1 md:ml-[104px]">
      ...
      <div className="z-2 -mt-[450px] md:-mt-[810px] h-auto md:h-[764px] w-full md:w-[1146px] flex flex-col gap-5 md:gap-[50px] bg-gradient-to-r from-white to-transparent via-[rgba(255,255,255,0.82)] px-4 md:px-0">
