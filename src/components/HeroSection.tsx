...
const HeroSection: React.FC = () => {
  return (
    <div className="flex flex-col ml-[104px]">
      ...
      <div className="z-10 -mt-[700px] h-auto w-[1146px] flex flex-col gap-[100px]">
        <p className="text-[62px] font-semibold leading-[120%] tracking-[-1.24px] text-[#011632] capitalize">Healthcare you can trust</p>
        <div>
            <p className="text-[40px] font-medium leading-[155%] tracking-[0.3px]">Your health, our priority</p>
            ...
            <div className="mt-[30px] flex flex-row gap-10">
                <button className="w-auto h-auto py-[12px] px-[20px] bg-primary_blue flex flex-row items-center justify-center rounded-full gap-[15px]">
                    <p className="text-[16px] text-white font-semibold">Book an appointment</p>
                    <Image src={icon} alt="arrow up right"></Image>
                </button>
                <div className="flex flex-row items-center justify-center gap-10">
                    <Image src={calling} alt="caller-image" className="h-[20px] w-[20px]"></Image>
                    <div>
