...
const Header: React.FC = () => {
    return (
        <div className="max-sm:hidden h-[34px] w-full bg-accent_blue  text-white">
            <section className='w-full h-full lg:max-w-[1450px] mx-auto flex flex-row items-center justify-between px-10'>
